...
Log4js.Level.prototype = {
  ...
  toLevel: function (sArg, defaultLevel) {
    ...
    if (typeof sArg === 'string') {
      ...
      switch (sArg) {
        case Log4js.Level.ALL_INT: return Log4js.Level.ALL
        case Log4js.Level.DEBUG_INT: return Log4js.Level.DEBUG
        case Log4js.Level.INFO_INT: return Log4js.Level.INFO
        case Log4js.Level.WARN_INT: return Log4js.Level.WARN
        case Log4js.Level.ERROR_INT: return Log4js.Level.ERROR
        case Log4js.Level.FATAL_INT: return Log4js.Level.FATAL
        case Log4js.Level.OFF_INT: return Log4js.Level.OFF
        case Log4js.Level.TRACE_INT: return Log4js.Level.TRACE
        default: return defaultLevel
      }
    } else {
      return defaultLevel
