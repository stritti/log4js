...
Log4js.AjaxAppender.prototype = Log4js.extend(
  new Log4js.Appender(),
  /** @lends Log4js.AjaxAppender# */ {
    /**
    ...
    send: function () {
      if (this.loggingEventMap.length() > 0) {
        ...
        this.httpRequest.setRequestHeader('REFERER', location.href) // eslint-disable-line
    ...
    onReadyStateChanged: function () {
      ...
      if (success) {
        ...
        var msg =
          '  AjaxAppender.onReadyStateChanged: XMLHttpRequest request to URL ' +
          this.loggingUrl +
    ...
    getXmlHttpRequest: function () {
      ...
      try {
        if (window.XMLHttpRequest) {
          // Mozilla, Safari, IE7...
          httpRequest = new XMLHttpRequest() // eslint-disable-line
          ...
          // IE
          try {
            httpRequest = new ActiveXObject('Msxml2.XMLHTTP') // eslint-disable-line
          } catch (e) {
            httpRequest = new ActiveXObject('Microsoft.XMLHTTP') // eslint-disable-line
          }
        }
      } catch (e) {
        httpRequest = false
      ...
      if (!httpRequest) {
        log4jsLogger && log4jsLogger.fatal('Unfortunately, your browser does not support AjaxAppender for log4js!') // eslint-disable-line
      }

      log4jsLogger && log4jsLogger.trace('< AjaxAppender.getXmlHttpRequest') // eslint-disable-line
      return httpRequest
    },
    /**
     * toString
