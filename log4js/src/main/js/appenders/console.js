...
Log4js.ConsoleAppender.prototype = Log4js.extend(
  new Log4js.Appender(),
  /** @lends Log4js.ConsoleAppender# */ {
    /**
    ...
    initialize: function () {
      if (!this.inline) {
        ...
        window.top.consoleWindow = window.open(
          '',
          winName,
        ...
        if (!win) {
          ...
          alert(
            // eslint-disable-line
            'Popup window manager blocking the Log4js popup window to bedisplayed.\n\n' +
      ...
      Log4js.attachEvent(
        this.tagFilterElement,
        'click',
        Log4js.bind(function () {
      ...
      if (e.keyCode === 13) {
        ...
        switch (command) {
          ...
          default:
            ...
            try {
              consoleOutput = eval(this.inputElement.value) // eslint-disable-line
            } catch (e) {
