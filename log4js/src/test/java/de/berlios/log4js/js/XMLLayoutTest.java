...
public class XMLLayoutTest extends AbstractLog4jsTestCase {

	public XMLLayoutTest(String name) {
		super(name);
	}
	...
	public void testLayoutInterface() {
		...
		eval("var layout = new Log4js.XMLLayout();");
